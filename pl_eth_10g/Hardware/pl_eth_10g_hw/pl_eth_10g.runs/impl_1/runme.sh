...
HD_PWD='C:/pl_eth_10g/Hardware/pl_eth_10g_hw/pl_eth_10g.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_eth_10g_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pl_eth_10g_wrapper.tcl -notrace
