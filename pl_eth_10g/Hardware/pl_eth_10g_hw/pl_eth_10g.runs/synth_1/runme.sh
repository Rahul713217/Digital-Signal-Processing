...
HD_PWD='C:/pl_eth_10g/Hardware/pl_eth_10g_hw/pl_eth_10g.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pl_eth_10g_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pl_eth_10g_wrapper.tcl
