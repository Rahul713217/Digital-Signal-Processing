...
# Path of this script: C:\Saikat_Projects\test\sw\hello_world_system\_ide\scripts\systemdebugger_hello_world_system_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source C:\Saikat_Projects\test\sw\hello_world_system\_ide\scripts\systemdebugger_hello_world_system_standalone.tcl
# 
